...
#include "AsepriteImportFactory.generated.h"
...
UCLASS()
class UAsepriteImportFactory : public UFactory
{
...
protected:
	FAsepriteJsonImporter Importer;
	// FString ExtractSpriteSheetFromAseprite(FString InFilename);
};
